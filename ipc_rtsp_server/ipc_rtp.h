#ifndef __IPC_RTP_H__
#define __IPC_RTP_H__
...
/*****************************************************************************
 函 数 名: rtp_pcma_alloc
 功能描述  : RTP封装PCMA的音频帧 每个RTP包都包含RTP OVER TCP的交错帧头
 输入参数  : _pu8Frame 音频帧
            _u32FrameSize 帧大小
...
/*****************************************************************************
 函 数 名: rtp_aac_alloc
 功能描述  : RTP封装AAC的音频帧 每个RTP包都包含RTP OVER TCP的交错帧头
 输入参数  : _pu8Frame 音频帧
            _u32FrameSize 帧大小
            _pu16SeqNumber RTP包的序号
            _u32Timestamp RTP包的时间戳
